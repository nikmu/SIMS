 ...
 * 类描述：日期工具类
 * 创建人：张俊   
 * 创建时间：2016年2月5日 下午5:29:16   
 * 修改人：张俊   
 * 修改时间：2016年2月5日 下午5:29:16   
 * 修改备注：   
 * @version 1.0  
 *
 */
...
public class DateUtil {
	...
	public static String DEFAULT_DATE_FORMATSIMPLIFY = null;// 不带符号日期（主要用于主键生成）
	 ...
	 * @return
	 */
	public static String formatDateSimplify(Date date) {
		SimpleDateFormat sdf = new SimpleDateFormat(DEFAULT_DATE_FORMATSIMPLIFY);
		return sdf.format(date);
	}
	 ...
	 * @return
	 */
	public static String formatDateTimeSimplify(Date date) {
		SimpleDateFormat sdf = new SimpleDateFormat(SPECAL_DATE_FORMAT);
		return sdf.format(date);
	}
	
	/**
	 * 格式化时期时间格式——不带符号
	 * SPECALCHAR_DATE_FORMAT
	 * @param date
	 * @return
	 */
	public static String formatDateTimeSpecalchar(Date date) {
		SimpleDateFormat sdf = new SimpleDateFormat(SPECALCHAR_DATE_FORMAT);
		return sdf.format(date);
	}

	/**
	 * 转换为日期时间格式（即：yyyy-MM-dd HH:mm:ss）
	 * 
	 * @param date 日期格式的String类型
	 * @return 
	 */
...
//	}
	 ...
	 * 
	 * public static String getDateString4Oracle(){ DateFormat formatter = new
	 * SimpleDateFormat(Day_MONTH_YEAR__FORMAT,Locale.ENGLISH); Calendar
	 * calendar = Calendar.getInstance(); return
	 * formatter.format(calendar.getTime()); }
	 * 
	 * public static String getDateString4OracleLong(){ DateFormat formatter =
	 * new SimpleDateFormat(Day_MONTH_YEAR__FORMAT_LONG,Locale.ENGLISH);
	 * Calendar calendar = Calendar.getInstance(); return
	 * formatter.format(calendar.getTime()); }
	 */
	...
	public static String getLastDayOfMonth(String checkedMonth) {
		...
		try {
			...
			if (!StringUtils.isBlank(checkedMonth)) {
				date = new SimpleDateFormat(YEAR_MONTH_FORMAT)
						.parse(checkedMonth);
			}
			Date lastDateOfMonth = lastDayOfMonth(date);
			result = new SimpleDateFormat(LONG_DATE_FORMAT)
					.format(lastDateOfMonth);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return result;
	...
	public static String getBeforeDay(String date, int num) {
		...
		return new SimpleDateFormat(SHORT_DATE_FORMAT).format(calendar
				.getTime());
	}
	...
	public static String sqlValue(Object fieldValue) {
		...
		if (className.equals("java.lang.String"))
			...
			return "date_format('" + date2Str((Date) fieldValue, "1")
					+ "','%Y-%m-%d HH:mm:ss')";
		else
	 ...
	 *            被格式化的日期时间变量
	 * @param formatType
	 *            有3种：1：yyyy-MM-dd HH:mm:ss，2：yyyy-MM-dd,3：yyyy-MM-dd HH:mm
	 * @return 格式化后的日期时间字符串
	 */
	 ...
	 * @throws ParseException
	 */
	public static Date stringToDate(String strDate, String DatePattern)
			throws ParseException {
	 ...
	 * @throws ParseException
	 */
	public static Date timeToDateTime(String time, String DatePattern)
			throws ParseException {
		DateFormat formatter = new SimpleDateFormat(DatePattern);
		Calendar calendar = Calendar.getInstance();
		calendar.setTimeInMillis(Long.parseLong(time));
		return stringToDate(formatter.format(calendar.getTime()), DatePattern);
	}
	 ...
	 * @throws ParseException
	 */
	public static String timeToDateStr(String time, String DatePattern)
			throws ParseException {
		DateFormat formatter = new SimpleDateFormat(DatePattern);
		Calendar calendar = Calendar.getInstance();
		calendar.setTimeInMillis(Long.parseLong(time));
